...
public class bmr1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    EditText txt,txt2;
    float r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference.addSnapshotListener(bmr1.this, new EventListener<DocumentSnapshot>() {
            @Override
